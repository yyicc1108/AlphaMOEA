...
def data_generator(instance, run_num, NP=100, n_gen=100):
    ...
    problem = get_problem(instance, n_obj=8)
    ...
    return (np.mean(agemoea_times), np.mean(moead_times), np.mean(rvea_times))
...
if __name__ == '__main__':
    ...
    print(df_dtlz)
    df_dtlz.to_csv("DTLZ-MOEAs-MaOPs-Running-Times.csv", index=False)
